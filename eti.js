...
var divGraph = document.createElement("canvas");
divGraph.setAttribute("id", "graph1");

referenceNode.after(divGraph);
...
for (index in tab_pays) {
  ...
  obj_line_properties.borderColor =
